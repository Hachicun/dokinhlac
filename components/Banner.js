      ...
      >
        <div className="flex items-center mx-auto">
          <p className="flex items-center text-sm font-normal text-gray-500">
            ...
            <span>
              Đồng hành cùng Lục Khí để duy trì, phát triển phần mềm với nhiều tính năng hơn nữa.{' '}
              <Link href="/ungho" className="inline font-medium text-blue-600 underline underline-offset-2 decoration-600 decoration-solid hover:no-underline">
                Đồng hành ngay
              </Link>
            </span>
          </p>
